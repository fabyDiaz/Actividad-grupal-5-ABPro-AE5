...
ALTER TABLE usuario DROP COLUMN zona_horaria;
Alter Table usuario add column zona_horaria varchar(5) default 'UTC-2' after contrasena;
...
/*cambiamos el nombre del campo "telefono" por "telefono de contacto"*/
ALTER TABLE contacto CHANGE COLUMN telefono telefono_de_contacto VARCHAR(12);  
